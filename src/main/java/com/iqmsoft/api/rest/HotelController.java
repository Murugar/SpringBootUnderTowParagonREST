...
import com.iqmsoft.service.HotelService;
...
@Api(tags = { "hotels" })
public class HotelController extends BaseRestHandler {
	...
	public ResponseEntity<Page<Hotel>> getAllHotel(
		...
		return new ResponseEntity<>(this.hotelService.getAllHotels(page, size), HttpStatus.OK);
	}
